...
URL = "https://github.com/PocketMiner82/skill-homeassistant"
SKILL_CLAZZ = "HomeAssistantSkill"  # needs to match __init__.py class name
PYPI_NAME = "skill-homeassistant"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description='OVOS Skill/Integration for Homeassistant',
    long_description=long_description,
    long_description_content_type="text/markdown",
    url=URL,
    author=SKILL_AUTHOR,
    author_email='pocket.miner@gmx.de',
    license='GNU LGPLv3',
    packages=[SKILL_PKG],
